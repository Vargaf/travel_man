...
class TravelManCommand extends Command
{
    ...
    protected function configure()
    {
        ...
        ->addArgument('maxNodesToForesight', InputArgument::OPTIONAL, 'The number of nodes to foreseight to find the neares path. The more the slower, but that not means to be more accurate.', 5)
    ;
    }
